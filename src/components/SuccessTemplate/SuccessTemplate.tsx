    ...
    <div>
      ...
      >
        ...
        <div className="text-center">
          <h1 className="text-black-3 text-[1.88rem] font-medium">
            <span className="font-bold">{titleBold} </span>
            {titleLight}
          </h1>
          <p className="text-[0.88rem] mt-4 w-[30rem] block mx-auto">
            {subTitle}
          </p>
        </div>
        <Link href={darkBtnLink}>
          <UnstyledButton
            ...
            class="w-[30rem] block  mt-10 text-[1.13rem] font-bold py-4 rounded-md  text-center mx-auto bg-black-2 text-white "
          >
            {darkButtonContent}
          </UnstyledButton>
        </Link>
