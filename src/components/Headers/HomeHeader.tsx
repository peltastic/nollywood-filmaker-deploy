    ...
    <header className="md:px-[2rem] md:pt-[2rem] lg:pb-0 text-white">
      ...
      >
        ...
        <div className="w-[100%] lg:w-[70%] xl:w-[55%]  mx-auto xl:mx-0  xl:ml-auto text-[1rem] px-4 xs:px-6 sm:px-0">
          <div className="sm:ml-6 mt-[5rem] xs:mt-[8rem] sm:mt-[17rem] xl:mt-[8rem]">
            ...
            <div className="mt-10 text-black-2 flex flex-wrap items-center font-semibold">
              <Link href={"/get-started"} className="w-full sm:w-auto">
                {/* <UnstyledButton class="py-4 text-center w-full sm:w-[12rem] sm:mr-5 rounded-md bg-yellow-1">
                  Get Started
                </UnstyledButton> */}
              ...
              <UnstyledButton class="transition-all hover:scale-110 hover:rotate-3 py-4 w-full sm:w-auto mx-auto xs:mx-0 flex justify-center items-center mt-5 xs:mt-0">
